...
ila_i2c inst_ila_i2c (
    ...
    .probe0(rd_done), // input wire [0:0]  probe0  
    .probe1(wr_done), // input wire [0:0]  probe1 
    .probe2(rd_data), // input wire [7:0]  probe2 
    .probe3(wr_data), // input wire [7:0]  probe3 
    .probe4(state), // input wire [3:0]  probe4 
    .probe5(rd_index), // input wire [8:0]  probe5 
    .probe6(wr_index), // input wire [8:0]  probe6 
    .probe7(lut_data) // input wire [23:0]  probe7
);
endmodule
