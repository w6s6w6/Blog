...
ila_0 inst_ila0 (
	...
	.probe2(wr_req), // input wire [0:0]  probe2 
	.probe3(wr_sda), // input wire [0:0]  probe3 
	.probe4(rd_req), // input wire [0:0]  probe4 
	.probe5(rd_done), // input wire [0:0]  probe5 
	.probe6(ack_flag), // input wire [0:0]  probe6 
	.probe7(start), // input wire [0:0]  probe7 
	.probe8(rd_data), // input wire [7:0]  probe8 
	.probe9(wr_data), // input wire [7:0]  probe9 
	.probe10(dev_addr), // input wire [7:0]  probe10 
	.probe11(mem_addr) // input wire [7:0]  probe11
);
endmodule
